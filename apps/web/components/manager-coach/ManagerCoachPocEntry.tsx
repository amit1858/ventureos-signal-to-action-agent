// AI Sales Director — POC entry card.
//
// A clearly-labelled, experimental entry rendered inside the Command Center
// (seller persona). It only links to the dedicated POC route; it loads NO
// Soul Machines resources itself. When the POC flag is disabled it renders
// nothing, so the existing Command Center is byte-identical.
...
export function ManagerCoachPocEntry() {
  ...
  return (
    <div className="card-premium border-dashed p-4">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="min-w-0 flex-1 space-y-1.5">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-semibold text-ink">{PERSONA_NAME}</h3>
          ...
          <p className="max-w-prose text-[13px] leading-relaxed text-muted">
            ...
            an isolated presentation experiment — it does not change any ranking,
            recommendation, governance, approval or CRM logic.
          </p>
        </div>
